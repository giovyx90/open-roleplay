...
final class OpenCoreModuleRegistration {
    ...
    boolean register() {
        ...
        try {
            ...
            plugin.getLogger().info("[OpenCosmetics] Registrato in OpenCore.");
            return true;
        } catch (ReflectiveOperationException | LinkageError error) {
            plugin.getLogger().warning("[OpenCosmetics] OpenCore trovato, ma registrazione modulo fallita: " + error.getMessage());
            openCore = null;
            moduleProxy = null;
            coreClass = null;
            moduleClass = null;
    ...
    void unregister() {
        ...
        try {
            ...
            plugin.getLogger().warning("[OpenCosmetics] Unregister da OpenCore fallito: " + error.getMessage());
        } finally {
            openCore = null;
            moduleProxy = null;
            coreClass = null;
    ...
    private InvocationHandler moduleHandler() {
        return (proxy, method, args) -> switch (method.getName()) {
            ...
            case "toString" -> "OpenCosmeticsModule";
